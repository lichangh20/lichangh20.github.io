...
\begin{cvitems}
  \item Dseveloped teacher-interleaved rollouts that combine on-policy state coverage with dense expert supervision, reducing covariate shift in long-horizon LLM agents.
